...
model = pipeline.make_pipeline(SimpleImputer(), preprocessing.RobustScaler(), XGBRegressor(**params)).fit(x_train, y_train)
...
mlflow.set_experiment("Suggested model")
...
with mlflow.start_run():
    ...
    model_info = mlflow.sklearn.log_model(
        ...
        registered_model_name="xgboost_with_imputer",
    )
